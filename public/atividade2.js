...
(function () {
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = '../../../public/atividade2.data';
    var REMOTE_PACKAGE_BASE = 'atividade2.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency']('datafile_../../../public/atividade2.data');
      }
      Module['addRunDependency']('datafile_../../../public/atividade2.data');
  ...
  loadPackage({
    files: [
      { filename: '/assets/UnlitVertexColor.frag', start: 0, end: 92, audio: 0 },
      { filename: '/assets/UnlitVertexColor.vert', start: 92, end: 597, audio: 0 },
    ],
    remote_package_size: 597,
    package_uuid: '56758f81-1f4e-483c-9529-250a5f8912fc',
  });
})();
var moduleOverrides = {};
var key;
...
var wasmBinaryFile = 'atividade2.wasm';
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    Module['asm'] = exports;
    wasmMemory = Module['asm']['Bg'];
    updateGlobalBufferAndViews(wasmMemory.buffer);
    wasmTable = Module['asm']['Lg'];
...
var asmLibraryArg = {
  ...
  gc: _emscripten_glClearBufferfi,
  hc: _emscripten_glClearBufferfv,
  jc: _emscripten_glClearBufferiv,
  ic: _emscripten_glClearBufferuiv,
  Qf: _emscripten_glClearColor,
  Pf: _emscripten_glClearDepthf,
  Of: _emscripten_glClearStencil,
  Tb: _emscripten_glClientWaitSync,
  ...
  ec: _emscripten_glCopyBufferSubData,
  ...
  wg: _emscripten_glDeleteQueriesEXT,
  Bf: _emscripten_glDeleteRenderbuffers,
  Mb: _emscripten_glDeleteSamplers,
  Af: _emscripten_glDeleteShader,
  Ub: _emscripten_glDeleteSync,
  zf: _emscripten_glDeleteTextures,
  Bb: _emscripten_glDeleteTransformFeedbacks,
  Kc: _emscripten_glDeleteVertexArrays,
  lg: _emscripten_glDeleteVertexArraysOES,
  ...
  Yb: _emscripten_glDrawArraysInstanced,
  hg: _emscripten_glDrawArraysInstancedANGLE,
  qd: _emscripten_glDrawArraysInstancedARB,
  rd: _emscripten_glDrawArraysInstancedEXT,
  ...
  Xb: _emscripten_glDrawElementsInstanced,
  gg: _emscripten_glDrawElementsInstancedANGLE,
  nd: _emscripten_glDrawElementsInstancedARB,
  od: _emscripten_glDrawElementsInstancedEXT,
  ...
  Fc: _emscripten_glEndTransformFeedback,
  Wb: _emscripten_glFenceSync,
  nf: _emscripten_glFinish,
  mf: _emscripten_glFlush,
  Mc: _emscripten_glFlushMappedBufferRange,
  ...
  xg: _emscripten_glGenQueriesEXT,
  df: _emscripten_glGenRenderbuffers,
  Nb: _emscripten_glGenSamplers,
  cf: _emscripten_glGenTextures,
  Ab: _emscripten_glGenTransformFeedbacks,
  Jc: _emscripten_glGenVertexArrays,
  kg: _emscripten_glGenVertexArraysOES,
  ff: _emscripten_glGenerateMipmap,
  bf: _emscripten_glGetActiveAttrib,
  af: _emscripten_glGetActiveUniform,
  $b: _emscripten_glGetActiveUniformBlockName,
  ac: _emscripten_glGetActiveUniformBlockiv,
  cc: _emscripten_glGetActiveUniformsiv,
  $e: _emscripten_glGetAttachedShaders,
  _e: _emscripten_glGetAttribLocation,
  Ze: _emscripten_glGetBooleanv,
  Ob: _emscripten_glGetBufferParameteri64v,
  ...
  Ve: _emscripten_glGetFramebufferAttachmentParameteriv,
  Pb: _emscripten_glGetInteger64i_v,
  Rb: _emscripten_glGetInteger64v,
  Hc: _emscripten_glGetIntegeri_v,
  Ue: _emscripten_glGetIntegerv,
  ob: _emscripten_glGetInternalformativ,
  wb: _emscripten_glGetProgramBinary,
  Se: _emscripten_glGetProgramInfoLog,
  Te: _emscripten_glGetProgramiv,
  og: _emscripten_glGetQueryObjecti64vEXT,
  qg: _emscripten_glGetQueryObjectivEXT,
  ng: _emscripten_glGetQueryObjectui64vEXT,
  _c: _emscripten_glGetQueryObjectuiv,
  pg: _emscripten_glGetQueryObjectuivEXT,
  $c: _emscripten_glGetQueryiv,
  rg: _emscripten_glGetQueryivEXT,
  Re: _emscripten_glGetRenderbufferParameteriv,
  Eb: _emscripten_glGetSamplerParameterfv,
  Fb: _emscripten_glGetSamplerParameteriv,
  Pe: _emscripten_glGetShaderInfoLog,
  Oe: _emscripten_glGetShaderPrecisionFormat,
  Ne: _emscripten_glGetShaderSource,
  Qe: _emscripten_glGetShaderiv,
  Me: _emscripten_glGetString,
  fc: _emscripten_glGetStringi,
  Qb: _emscripten_glGetSynciv,
  Le: _emscripten_glGetTexParameterfv,
  Ke: _emscripten_glGetTexParameteriv,
  Bc: _emscripten_glGetTransformFeedbackVarying,
  bc: _emscripten_glGetUniformBlockIndex,
  dc: _emscripten_glGetUniformIndices,
  ...
  zc: _emscripten_glGetVertexAttribIiv,
  yc: _emscripten_glGetVertexAttribIuiv,
  De: _emscripten_glGetVertexAttribPointerv,
  Ge: _emscripten_glGetVertexAttribfv,
  Ee: _emscripten_glGetVertexAttribiv,
  Ce: _emscripten_glHint,
  sb: _emscripten_glInvalidateFramebuffer,
  rb: _emscripten_glInvalidateSubFramebuffer,
  ...
  vg: _emscripten_glIsQueryEXT,
  xe: _emscripten_glIsRenderbuffer,
  Lb: _emscripten_glIsSampler,
  we: _emscripten_glIsShader,
  Vb: _emscripten_glIsSync,
  ...
  Nc: _emscripten_glMapBufferRange,
  yb: _emscripten_glPauseTransformFeedback,
  re: _emscripten_glPixelStorei,
  qe: _emscripten_glPolygonOffset,
  vb: _emscripten_glProgramBinary,
  tb: _emscripten_glProgramParameteri,
  sg: _emscripten_glQueryCounterEXT,
  ...
  xb: _emscripten_glResumeTransformFeedback,
  ...
  le: _emscripten_glScissor,
  ke: _emscripten_glShaderBinary,
  je: _emscripten_glShaderSource,
  ie: _emscripten_glStencilFunc,
  he: _emscripten_glStencilFuncSeparate,
  ge: _emscripten_glStencilMask,
  fe: _emscripten_glStencilMaskSeparate,
  ee: _emscripten_glStencilOp,
  de: _emscripten_glStencilOpSeparate,
  ce: _emscripten_glTexImage2D,
  jd: _emscripten_glTexImage3D,
  be: _emscripten_glTexParameterf,
  ae: _emscripten_glTexParameterfv,
  $d: _emscripten_glTexParameteri,
  _d: _emscripten_glTexParameteriv,
  qb: _emscripten_glTexStorage2D,
  pb: _emscripten_glTexStorage3D,
  Zd: _emscripten_glTexSubImage2D,
  id: _emscripten_glTexSubImage3D,
  Cc: _emscripten_glTransformFeedbackVaryings,
  Yd: _emscripten_glUniform1f,
  Xd: _emscripten_glUniform1fv,
  Wd: _emscripten_glUniform1i,
  Vd: _emscripten_glUniform1iv,
  rc: _emscripten_glUniform1ui,
  nc: _emscripten_glUniform1uiv,
  Ud: _emscripten_glUniform2f,
  Td: _emscripten_glUniform2fv,
  Sd: _emscripten_glUniform2i,
  Rd: _emscripten_glUniform2iv,
  qc: _emscripten_glUniform2ui,
  mc: _emscripten_glUniform2uiv,
  Qd: _emscripten_glUniform3f,
  Pd: _emscripten_glUniform3fv,
  Od: _emscripten_glUniform3i,
  Nd: _emscripten_glUniform3iv,
  pc: _emscripten_glUniform3ui,
  lc: _emscripten_glUniform3uiv,
  Md: _emscripten_glUniform4f,
  Ld: _emscripten_glUniform4fv,
  Kd: _emscripten_glUniform4i,
  Jd: _emscripten_glUniform4iv,
  oc: _emscripten_glUniform4ui,
  kc: _emscripten_glUniform4uiv,
  _b: _emscripten_glUniformBlockBinding,
  Id: _emscripten_glUniformMatrix2fv,
  Wc: _emscripten_glUniformMatrix2x3fv,
  Uc: _emscripten_glUniformMatrix2x4fv,
  Hd: _emscripten_glUniformMatrix3fv,
  Vc: _emscripten_glUniformMatrix3x2fv,
  Sc: _emscripten_glUniformMatrix3x4fv,
  Gd: _emscripten_glUniformMatrix4fv,
  ...
  nb: _emscripten_glVertexAttribDivisorNV,
  xc: _emscripten_glVertexAttribI4i,
  ...
  vd: _emscripten_glVertexAttribPointer,
  ud: _emscripten_glViewport,
  Sb: _emscripten_glWaitSync,
  L: _emscripten_has_asyncify,
  eb: _emscripten_memcpy_big,
  Ag: _emscripten_request_fullscreen_strategy,
  ea: _emscripten_request_pointerlock,
  j: _emscripten_resize_heap,
  Zb: _emscripten_run_script,
  ...
  E: _emscripten_set_gamepaddisconnected_callback_on_thread,
  ...
  ue: _emscripten_set_main_loop_arg,
  ...
  da: _emscripten_set_mousemove_callback_on_thread,
  ba: _emscripten_set_mouseup_callback_on_thread,
  ...
  _: _emscripten_set_wheel_callback_on_thread,
  J: _emscripten_sleep,
  ib: _emscripten_thread_sleep,
  gb: _environ_get,
...
var ___wasm_call_ctors = (Module['___wasm_call_ctors'] = function () {
  return (___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['Cg']).apply(
    null,
    arguments,
  );
});
...
var _fflush = (Module['_fflush'] = function () {
  return (_fflush = Module['_fflush'] = Module['asm']['Eg']).apply(null, arguments);
});
var ___errno_location = (Module['___errno_location'] = function () {
  return (___errno_location = Module['___errno_location'] = Module['asm']['Fg']).apply(
    null,
    arguments,
  );
});
var _malloc = (Module['_malloc'] = function () {
  return (_malloc = Module['_malloc'] = Module['asm']['Gg']).apply(null, arguments);
});
...
var dynCall_iiiiiijj = (Module['dynCall_iiiiiijj'] = function () {
  return (dynCall_iiiiiijj = Module['dynCall_iiiiiijj'] = Module['asm']['Rg']).apply(
    null,
    arguments,
  );
});
